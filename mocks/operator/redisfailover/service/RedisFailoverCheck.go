...
func (_m *RedisFailoverCheck) GetMasterIP(rFailover *v1alpha2.RedisFailover) (string, error) {
	...
	var r0 string
	if rf, ok := ret.Get(0).(func(*v1alpha2.RedisFailover) string); ok {
		r0 = rf(rFailover)
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*v1alpha2.RedisFailover) error); ok {
		r1 = rf(rFailover)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *RedisFailoverCheck) GetMinimumRedisPodTime(rFailover *v1alpha2.RedisFailover) (time.Duration, error) {
	...
	if rf, ok := ret.Get(0).(func(*v1alpha2.RedisFailover) time.Duration); ok {
		r0 = rf(rFailover)
	} else {
...
func (_m *RedisFailoverCheck) GetNumberMasters(rFailover *v1alpha2.RedisFailover) (int, error) {
	...
	var r0 int
	if rf, ok := ret.Get(0).(func(*v1alpha2.RedisFailover) int); ok {
		r0 = rf(rFailover)
	} else {
		r0 = ret.Get(0).(int)
	}
