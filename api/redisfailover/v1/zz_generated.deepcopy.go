...
func (in *RedisSettings) DeepCopyInto(out *RedisSettings) {
	*out = *in
	...
	if in.SysctlInit != nil {
		in, out := &in.SysctlInit, &out.SysctlInit
		if *in == nil {
			*out = nil
		} else {
			*out = new(RedisSysctlInit)
			(*in).DeepCopyInto(*out)
		}
	}
	if in.Env != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisSysctlInit) DeepCopyInto(out *RedisSysctlInit) {
	*out = *in
	if in.Command != nil {
		in, out := &in.Command, &out.Command
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisSysctlInit.
func (in *RedisSysctlInit) DeepCopy() *RedisSysctlInit {
	if in == nil {
		return nil
	}
	out := new(RedisSysctlInit)
