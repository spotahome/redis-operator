...
func (in *RedisFailoverStatus) DeepCopyInto(out *RedisFailoverStatus) {
	*out = *in
	if in.RedisRestartedAt != nil {
		in, out := &in.RedisRestartedAt, &out.RedisRestartedAt
		*out = (*in).DeepCopy()
	}
	if in.SentinelRestartedAt != nil {
		in, out := &in.SentinelRestartedAt, &out.SentinelRestartedAt
		*out = (*in).DeepCopy()
	}
	return
}
