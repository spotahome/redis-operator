...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthV2Settings) DeepCopyInto(out *AuthV2Settings) {
	*out = *in
	if in.Users != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthV2Settings.
func (in *AuthV2Settings) DeepCopy() *AuthV2Settings {
	if in == nil {
		return nil
	}
	out := new(AuthV2Settings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RedisFailoverSpec) DeepCopyInto(out *RedisFailoverSpec) {
	*out = *in
	...
	out.Auth = in.Auth
	in.AuthV2.DeepCopyInto(&out.AuthV2)
