...
func (p *PodDisruptionBudgetService) GetPodDisruptionBudget(namespace string, name string) (*policyv1beta1.PodDisruptionBudget, error) {
	podDisruptionBudget, err := p.kubeClient.PolicyV1beta1().PodDisruptionBudgets(namespace).Get(context.Background(), name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func (p *PodDisruptionBudgetService) CreatePodDisruptionBudget(namespace string, podDisruptionBudget *policyv1beta1.PodDisruptionBudget) error {
	_, err := p.kubeClient.PolicyV1beta1().PodDisruptionBudgets(namespace).Create(context.Background(), podDisruptionBudget, metav1.CreateOptions{})
	if err != nil {
		return err
	}
...
func (p *PodDisruptionBudgetService) UpdatePodDisruptionBudget(namespace string, podDisruptionBudget *policyv1beta1.PodDisruptionBudget) error {
	_, err := p.kubeClient.PolicyV1beta1().PodDisruptionBudgets(namespace).Update(context.Background(), podDisruptionBudget, metav1.UpdateOptions{})
	if err != nil {
		return err
	}
...
func (p *PodDisruptionBudgetService) DeletePodDisruptionBudget(namespace string, name string) error {
	return p.kubeClient.PolicyV1beta1().PodDisruptionBudgets(namespace).Delete(context.Background(), name, metav1.DeleteOptions{})
}
