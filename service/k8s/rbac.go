...
func (r *RBACService) GetClusterRole(name string) (*rbacv1.ClusterRole, error) {
	return r.kubeClient.RbacV1().ClusterRoles().Get(context.Background(), name, metav1.GetOptions{})
}

func (r *RBACService) GetRole(namespace, name string) (*rbacv1.Role, error) {
	return r.kubeClient.RbacV1().Roles(namespace).Get(context.Background(), name, metav1.GetOptions{})
}

func (r *RBACService) GetRoleBinding(namespace, name string) (*rbacv1.RoleBinding, error) {
	return r.kubeClient.RbacV1().RoleBindings(namespace).Get(context.Background(), name, metav1.GetOptions{})
}

func (r *RBACService) DeleteRole(namespace, name string) error {
	err := r.kubeClient.RbacV1().Roles(namespace).Delete(context.Background(), name, metav1.DeleteOptions{})
	if err != nil {
		return err
	}
...
func (r *RBACService) CreateRole(namespace string, role *rbacv1.Role) error {
	_, err := r.kubeClient.RbacV1().Roles(namespace).Create(context.Background(), role, metav1.CreateOptions{})
	if err != nil {
		return err
	}
...
func (s *RBACService) UpdateRole(namespace string, role *rbacv1.Role) error {
	_, err := s.kubeClient.RbacV1().Roles(namespace).Update(context.Background(), role, metav1.UpdateOptions{})
	if err != nil {
		return err
	}
...
func (r *RBACService) DeleteRoleBinding(namespace, name string) error {
	err := r.kubeClient.RbacV1().RoleBindings(namespace).Delete(context.Background(), name, metav1.DeleteOptions{})
	if err != nil {
		return err
	}
...
func (r *RBACService) CreateRoleBinding(namespace string, binding *rbacv1.RoleBinding) error {
	_, err := r.kubeClient.RbacV1().RoleBindings(namespace).Create(context.Background(), binding, metav1.CreateOptions{})
	if err != nil {
		return err
	}
...
func (r *RBACService) UpdateRoleBinding(namespace string, binding *rbacv1.RoleBinding) error {
	_, err := r.kubeClient.RbacV1().RoleBindings(namespace).Update(context.Background(), binding, metav1.UpdateOptions{})
	if err != nil {
		return err
	}
